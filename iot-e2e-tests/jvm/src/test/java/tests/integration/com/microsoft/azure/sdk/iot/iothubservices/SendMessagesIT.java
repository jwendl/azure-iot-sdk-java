...
public class SendMessagesIT
{
        ...
        public void sendMessages()
        {
            for (int i = 0; i < numMessagesPerConnection; ++i)
            {
                try
                {
                    ...
                    if (messageSent.callbackWasFired() && messageSent.getCallbackStatusCode() != IotHubStatusCode.OK_EMPTY)
                    {
    ...
    @Test
    public void tokenRenewalWorks() throws IOException, InterruptedException
    {
        ...
        testInstance.deviceClient.open();
